                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="mt-4">
                                                    <div class="font-size-14">
                                                        ...
                                                        <p class="mb-4">2. Kompetensi pimpinan</p>

                                                        <p class="mb-4">3. Kompetensi pimpinan universitas</p>

                                                        <p class="mb-4">4. Kompetensi karyawan</p>

                                                        <p class="mb-4">5. Kesempatan pelatihan yang disediakan oleh universitas</p>

                                                        <p class="mb-4">6. Gaji, tunjangan, dan jaminan sosial tenaga kerja</p>

                                                        <p class="mb-4">7. Beban kerja</p>

                                                        <p class="mb-4">8. Tanggung jawab</p>

                                                        <p class="mb-4">9. Keterlibatan dan pengaruh</p>

                                                        <p class="mb-4">10. Hubungan kerja antar karyawan</p>

                                                        <p class="mb-4">11. Kondisi ruang kerja</p>
