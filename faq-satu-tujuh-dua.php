                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="faq-box d-flex mb-4">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="font-size-15">Mengakses MAC IS dosen</h5>
                                                        <div class="d-flex align-items-center">
                                                            <p class="mb-0 me-2">Layanan Helpdesk untuk sivitas Universitas mengakses MAC IS dosen. Berikut adalah FAQ untuk mengakses MAC IS dosen</p>
                                                            <div class="event-up-icon">
                                                                <a href="faq-dosen.php"><i class="bx bx-right-arrow-circle h3 text-primary"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
