        ...
        <script>
            ...
            document.getElementById('kategori').addEventListener('change', function () {
                ...
                if (kategoriId) {
                    ...
                    fetch('get_subkategori.php?kategori=' + kategoriId) // Ensure this PHP file returns the subcategories
                    ...
                    document.getElementById('subsubkategori-container').style.display = 'none'; // Hide sub-subcategory
                }
            });

            // Event listener for the subcategory selection
            document.getElementById('subkategori').addEventListener('change', function() {
                var subkategoriId = this.value;
                ...
                if (subkategoriId) {
                    ...
                    fetch('get_subsubkategori.php?subkategori=' + subkategoriId) // Ensure this PHP file returns the detail subcategories
                        .then(response => response.json())
                        .then(data => {
