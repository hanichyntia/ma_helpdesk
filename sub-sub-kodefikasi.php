...
if ($id_sub_kodefikasi_tiket > 0) {
  ...
  $stmt = $conn->prepare("SELECT master_sub_sub_kodefikasi_tiket.*, master_sub_kodefikasi_tiket.nama_sub_kodefikasi_tiket 
                      ...
                      <div class="tab-content">
                        <div class="tab-pane fade show active">
                          ...
                          if ($result->num_rows > 0) {
                            while ($dt_sub_sub_katagori = $result->fetch_assoc()) {
                              ?>
                              <div class="faq-box d-flex mb-4">
                                ...
                                <div class="flex-grow-1">
                                  <h5 class="font-size-15"><?= $dt_sub_sub_katagori['nama_sub_sub_kodefikasi_tiket'] ?></h5>
                                  <div class="d-flex align-items-center">
                                    <p class="text-muted mb-0 me-2">Layanan Helpdesk untuk sivitas Universitas untuk reset
                                      password akun sistem informasi mahasiswa. Berikut adalah form pengajuan untuk reset
                                      password akun sistem informasi akademik mahasiswa</p>
