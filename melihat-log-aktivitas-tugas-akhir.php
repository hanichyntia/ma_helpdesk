                                                ...
                                                <div class="col-xl-8">
                                                    <div>
                                                        <div class="text-center">
                                                            ...
                                                            <h4>Melihat log aktivitas tugas akhir</h4>
                                                        ...
                                                        <div class="mt-4">
                                                            <div class="font-size-14">
                                                                ...
                                                                <p class="mb-4">2. Tahun ajaran</P>

                                                                <p class="mb-4">3. Nama dosen pembimbing</P>

                                                                <p class="mb-4">4. Nama dosen penguji</P>

                                                                <p class="mb-4">5. Jenis tugas akhir</P>
