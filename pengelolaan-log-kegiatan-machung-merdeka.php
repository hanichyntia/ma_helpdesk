                                                ...
                                                <div class="col-xl-8">
                                                    <div>
                                                        <div class="text-center">
                                                            ...
                                                            <h4>Pengelolaan log kegiatan Ma Chung Merdeka (MBKM)</h4>
                                                        ...
                                                        <div class="mt-4">
                                                            <div class="font-size-14">
                                                                <p>Mahasiswa dapat melakukan beberapa kegiatan pada Ma Chung Merdeka yaitu:</p>

                                                                <p class="mb-4">1. Menambah log kegiatan Ma Chung Merdeka</p>

                                                                <P class="mb-4">2. Melihat log kegiatan Ma Chung Merdeka</p>
                                                                ...
                                                                <p class="mb-4">4. Tahun</p>

                                                                <p class="mb-4">5. Semester</p>

                                                                <p class="mb-4">6. Kode MBKM</p>

                                                                <p class="mb-4">7. Jenis MBKM</p>

                                                                <p class="mb-4">8. Status keikutsertaan</p>

                                                                <p class="mb-4">9. Button tambah untuk menambah log kegiatan</p>
