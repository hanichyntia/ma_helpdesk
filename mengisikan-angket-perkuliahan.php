                                                ...
                                                <div class="col-xl-8">
                                                    <div>
                                                        <div class="text-center">
                                                            ...
                                                            <h4>Mengisikan angket perkuliahan</h4>
                                                        ...
                                                        <div class="mt-4">
                                                            <div class="font-size-14">
                                                                ...
                                                                <p class="mb-4">3. Kepenasihatan dan Sarana Prasarana</p>

                                                                <p class="mb-4">Untuk mengisikan angket perkuliahan tersebut, maka mahasiswa dapat membuka menu:</p>
                                                                
                                                                <p class="mb-4">1. <strong>Angket → Kepuasan Mahasiswa</strong></p>
                                                                ...
                                                                <p class="mb-4 ">2. Angket suasana</p>

                                                                <p class="mb-4 ">3. Angket sistem informasi</p>

                                                                <p class="mb-4 ">4. Angket perpustakaan</p>

                                                                <p class="mb-4 ">5. Angket laboratorium</p>

                                                                <p class="mb-4 ">6. Angket kelas</p>

                                                                <p class="mb-4 ">7. Angket fasilitas</p>
