                                                ...
                                                <div class="col-xl-8">
                                                    <div>
                                                        <div class="text-center">
                                                            ...
                                                            <h4>Melihat detail rekapitulasi poin keaktifan</h4>
                                                        ...
                                                        <div class="mt-4">
                                                            <div class="font-size-14">
                                                                ...
                                                                <img src="macismasis/melihat-detail-rekapitulasi-poin-keaktifan-dua.png" alt="" class="img-thumbnail mx-auto d-block">
                                                                ...
                                                                <p class="mb-4">4. Jenis kegiatan</p>
                                                                <p class="mb-4">5. Poin yang disetujui</p>
                                                                <p class="mb-4">6. Status poin keaktifan</p>
                                                                <p class="mb-4">7. Catatan persetujuan</p>
                                                                <p class="mb-4">8. Tanggal persetujuan dan persetujuan pengguna</p>
